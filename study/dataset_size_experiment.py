...
if __name__ == "__main__":
    ...
    assert (hasattr(args, "range") + hasattr(args, "range_percent") + hasattr(args, "size_at_cycle") + hasattr(args,
            "size_at_cycle_percent")) == 1, "one of `range`, `range_percent`, `size_at_cycle`, or \
    ...
    if args.range:
        ...
        data_size_cycle = [(float(n) * train_samples) for n in args.size_at_cycle_percent]
